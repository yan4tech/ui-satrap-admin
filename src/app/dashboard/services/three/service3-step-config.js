export const SERVICE3_STEPPER_LABELS = [
  'شروع',
  'پرداخت',
  'اطلاعات اولیه',
  'تایید توسط شرکت',
...
export function getService3StepperIndexForElementId(elementId) {
...
export function getService3BpmnElementIdForStepperIndex(stepIndex) {
...
export function getService3WorkflowRank(elementId) {
  return getService3StepperIndexForElementId(elementId);
}
